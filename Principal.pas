...
if form_login = nil then
   ...
   Label5.Caption := 'Usuário: '+ nomecomple;
   end;
   ...
   begin
      ...
      if (Form_pdv=Nil) then Application.CreateForm(TForm_pdv, Form_pdv);
         Form_pdv.ShowModal;
          ...
          begin
            showmessage ('ATENÇÃO ! VOCÊ DEVE ABRIR O CAIXA, ANTES DE REALIZAR UMA VENDA !');
          end;
 end;
...
begin
  if sairvenda = true then
    begin
    application.MessageBox('Atenção! o caixa ainda está aberto, Feche o caixa para poder sair !!!','Atenção Usuário',MB_ICONERROR);
    end
    else
